    ...
    <div class="detail-card glass">
      ...
      <div v-if="(demand.mediaUrls as any[])?.length" class="media-section">
        <div v-for="url in demand.mediaUrls" :key="url" class="media-item">
          <img v-if="url.match(/\.(jpg|jpeg|png|gif|webp)/i)" :src="url" loading="lazy" decoding="async" />
...
@media (max-width: 768px) { .bottom-actions { left: 0; bottom: calc(64px + env(safe-area-inset-bottom, 0px)); } }
