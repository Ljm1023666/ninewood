...
<template>
  <div class="chat-page full-width">
    ...
    <div v-if="uploadPreview" class="image-preview-bar">
      ...
      <img v-else :src="uploadPreview" class="preview-media" />
...
.chat-list::-webkit-scrollbar-thumb { background: var(--border-color); border-radius: 2px; }
...
.send-btn {
  ...
  background: #95ec69; border: none; border-radius: 6px;
