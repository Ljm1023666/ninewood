...
const certLabel: Record<string, string> = {
  NONE: '未认证', BASIC: '初级认证', INTERMEDIATE: '中级认证', ADVANCED: '高级认证', MASTER: '顶级认证',
};

const certColor: Record<string, string> = {
  NONE: '#6b7280', BASIC: '#3b82f6', INTERMEDIATE: '#8b5cf6', ADVANCED: '#f59e0b', MASTER: '#ef4444',
};
...
.cert-page::-webkit-scrollbar { width: 4px; }
.cert-page::-webkit-scrollbar-thumb { background: var(--border-color); border-radius: 2px; }
