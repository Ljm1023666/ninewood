...
const FAQ: FaqEntry[] = [
  ...
  },
  {
    ...
    q: '如何配置推送屏蔽？',
    intro:
      '推送设置已改为正向订阅：只在你选择的事情出现时提醒你。未订阅的机会、摘要和关系通知默认不会主动打扰。',
    steps: [
      {
        title: '进入推送设置',
      ...
      {
        title: '了解必要通知',
        content: '交易、资金、争议与安全提醒默认站内送达，不受每日打扰上限影响。',
      },
      {
        title: '订阅你关心的事项',
        content: '在「我主动订阅的事项」中添加需求匹配标签等订阅，并明确保存后才会生效。',
      },
      {
        title: '设置安静时段与每日上限',
        content: '可暂停全部非必要通知，或限制每日主动打扰次数。',
      },
      {
        title: '查看通知原因',
        content: '「最近为什么通知我」列出可解释的投递与抑制记录。',
      },
    ],
    tips: [
      {
        type: 'warning',
        content: '旧「默认接收 + 屏蔽」不会自动变成永久同意；排除规则仅作建议预填。',
      },
      {
        type: 'info',
    ...
    category: 'settings',
    keywords: ['推送', '屏蔽', '通知', '关键词', '标签过滤', '免打扰', '订阅'],
  },
  {
    id: 'switch-theme',
    q: '如何切换深色/浅色主题？',
