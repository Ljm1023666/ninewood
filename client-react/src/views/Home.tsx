    ...
    >
      ...
      <div className="relative z-10 box-border mx-auto flex w-full max-w-3xl shrink-0 flex-col items-stretch self-center px-4 pb-8 pt-6 sm:px-6">
        <div className="mb-6 flex w-full flex-col items-center text-center">
          <SparklesText text="发现" className="text-2xl sm:text-3xl tracking-tight text-text-primary" sparklesCount={8} />
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
            <Button
              ...
              className={cn(
                ...
                isDark
                  ? 'shadow-[0_0_0_1.5px_rgba(255,255,255,0.15)] bg-white/10 !text-white hover:bg-white/18'
                  : 'shadow-[0_0_0_1.5px_rgba(0,0,0,0.08)] bg-black/[0.04] !text-text-primary hover:bg-black/[0.08]',
              )}
