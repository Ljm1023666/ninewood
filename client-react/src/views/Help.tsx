...
const FAQ: FaqEntry[] = [
  ...
  },
  {
    ...
    q: '市场分析（标签统计）是什么？',
    intro:
      '标签统计页面以标签为维度展示市场指标和趋势数据，帮助您了解哪些服务需求旺盛、哪些标签机会更多。',
    steps: [
      {
        title: '进入市场分析',
        content:
          '点击左侧导航栏中的「市场分析」图标（BarChart3），进入标签统计页面。',
      },
      {
        title: '查看标签指标',
        content:
          '每个标签卡片展示：需求数量、活跃服务者数、平均报价、成交率等关键指标。',
      },
      {
        title: '趋势分析',
        content: '点击标签可展开详情，查看该标签下的需求趋势图、供需比变化等。',
      },
      {
        title: '辅助决策',
        content:
          '根据市场数据决策：接哪个方向的需求机会更多、报价应该在什么区间、哪些标签服务者相对稀缺。',
      },
    ],
    tips: [
      {
        type: 'tip',
        content:
          '如果某个标签"需求多、服务者少"（供不应求），说明该方向竞争小、接单成功率高。',
      },
      {
        type: 'info',
        content: '标签统计数据每小时更新一次，反映近 30 天的市场状态。',
      },
    ],
    relatedLinks: [{ text: '如何使用标签筛选需求？', faqId: 'how-to-tags' }],
    category: 'discover',
    keywords: ['市场分析', '标签统计', '指标', '趋势', '供需', '统计', '数据'],
  },
  {
