...
const STATIC_PATH_D = PATHS.join('') + PATH_TAIL
...
export const BackgroundBeams = React.memo(
  ({ className }: { className?: string }) => {
    ...
    return (
      <div
        className={cn(
          'pointer-events-none absolute inset-0 flex h-full w-full items-center justify-center [mask-image:radial-gradient(ellipse_at_center,white_30%,transparent_70%)]',
          className,
        )}
      >
        <svg
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset="0.0666667" stopColor="var(--text-secondary)" />
              <stop offset="0.243243" stopColor="var(--text-secondary)" />
              <stop
                offset="0.43594"
