...
const PortfolioPage: React.FC<PortfolioPageProps> = ({
  ...
  return (
    <div className="bg-background text-foreground geist-font flex-1 overflow-y-auto">
        ...
        >
          <div className="max-w-6xl mx-auto text-center">
            <div className="mb-8 float-animation">
              ...
              <p className="md:text-xl leading-relaxed inter-font text-lg font-light text-muted-foreground text-center">
                {hero.subtitle}
              </p>
            </div>
