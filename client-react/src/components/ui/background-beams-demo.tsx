    ...
    <div className="relative flex h-[40rem] w-full flex-col items-center justify-center rounded-md bg-neutral-950 antialiased">
      <div className="relative z-10 mx-auto max-w-2xl p-4">
        ...
        <input
          ...
          className="relative z-10 mt-4 w-full rounded-lg border border-neutral-800 bg-neutral-950 py-2 px-3 placeholder:text-neutral-700 focus:ring-2 focus:ring-teal-500 focus:outline-none"
        />
      </div>
      <BackgroundBeams />
    </div>
