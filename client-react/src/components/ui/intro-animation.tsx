...
function FlipCard({ src, index, target }: FlipCardProps) {
  ...
  return (
    // 1️⃣ 纯 div：transform 直接来自 target（已是 spring 平滑值），不动用 motion animate
    <div
      style={{
        position: 'absolute',
        width: IMG_WIDTH,
    ...
    >
      ...
      >
        {/* 3️⃣ 静态 3D 容器，will-change 提示 GPU 分配高质量纹理 */}
        <div
          style={{
            width: '100%',
            height: '100%',
        ...
        >
          {/* 4️⃣ 翻转层：CSS transition 代替 framer-motion whileHover */}
          <div
