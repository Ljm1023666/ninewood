...
export const AcetTailwindConnectButton = forwardRef<
  HTMLButtonElement,
  BtnProps
>(({ className, children, ...rest }, ref) => (
  <button
    ...
    type="button"
    className={cn(
      'group relative inline-block cursor-pointer rounded-full bg-slate-800 p-px text-sm font-semibold leading-6 text-white no-underline shadow-2xl shadow-zinc-900',
      className,
    )}
    {...rest}
  >
